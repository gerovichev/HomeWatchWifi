...
// Root CA for api.timezonedb.com. Its certificate is issued by Let's
...
static const char TIMEZONEDB_ROOT_CA[] PROGMEM = R"CERT(
-----BEGIN CERTIFICATE-----
...
void getTimezone() {
  ...
  BearSSL::X509List rootCA(TIMEZONEDB_ROOT_CA);
